...
export class OmniLPStakingProviderFactory extends Contract {
  connect(signer: Signer): OmniLPStakingProviderFactory {
    return super.connect(signer) as OmniLPStakingProviderFactory;
  }
...
const _abi = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'oldLpOracle', type: 'address' },
      { indexed: true, internalType: 'address', name: 'newLpOracle', type: 'address' },
    ],
    name: 'LpOracleSet',
    type: 'event',
  },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'previousToken', type: 'address' },
      { indexed: false, internalType: 'address', name: '_zeroToken', type: 'address' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'previousLocker', type: 'address' },
      { indexed: false, internalType: 'address', name: '_tokenLocker', type: 'address' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'address', name: '_votingPowerCombined', type: 'address' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'oldZeroAggregator', type: 'address' },
      { indexed: true, internalType: 'address', name: 'newZeroAggregator', type: 'address' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'newLockAmount', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_zeroToken', type: 'address' },
      { internalType: 'address', name: '_poolVoter', type: 'address' },
  ...
  },
  {
    inputs: [],
    name: 'rewardsToken',
    outputs: [{ internalType: 'contract IZeroLend', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'address', name: 'what', type: 'address' }],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'contract IVotingPowerCombined', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
];
