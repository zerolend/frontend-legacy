...
export class OmniStakingProviderFactory extends Contract {
  connect(signer: Signer): OmniStakingProviderFactory {
    return super.connect(signer) as OmniStakingProviderFactory;
  }
