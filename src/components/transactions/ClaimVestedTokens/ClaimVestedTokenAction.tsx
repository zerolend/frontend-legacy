...
export interface ClaimVestedTokenActionProps extends BoxProps {
...
export const ClaimVestedTokenAction = ({
  isApproved,
  handleLockAction,
  mainTxState,
  approvalTxState,
  ...
  function getMainParams() {
    ...
    if (isApproved) return { loading: false, disabled: false, content: `Claim Vest #${vestId}` };
    return { content: 'Claim Vest', handleClick: handleLockAction };
  }
