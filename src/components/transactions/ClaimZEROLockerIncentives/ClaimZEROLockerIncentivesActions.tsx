...
export interface ClaimZEROLockerIncentivesActionProps extends BoxProps {
...
export const ClaimZEROLockerIncentivesAction = ({
  isApproved,
  handleLockAction,
  mainTxState,
  approvalTxState,
  isClaimable,
}: ClaimZEROLockerIncentivesActionProps) => {
