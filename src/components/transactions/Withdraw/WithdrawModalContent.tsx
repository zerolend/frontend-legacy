...
interface ExtraWithdrawModalContentProps {
...
export const WithdrawModalContent = ({
  ...
  ExtraWithdrawModalContentProps & { unwrap: boolean; setUnwrap: (unwrap: boolean) => void }) => {
  ...
  const dontShowWithdrawWarning = localStorage.getItem('dontShowWithdrawWarning') === 'true';

  const [dontShowWithdrawWarningState, setDontShowWithdrawWarning] =
    useState<boolean>(dontShowWithdrawWarning);
      ...
      {!dontShowWithdrawWarningState && (
        ...
        >
          <Typography variant={'h2'} textAlign={'center'}>
            If you withdraw, you will stop earning future yields and points.
          </Typography>
          <Box display={'flex'} flexDirection={'column'} mt={6}>
            <Button variant={'contained'} sx={{ marginBottom: 4 }} onClick={() => handleClose()}>
              Keep Earning
            </Button>
            <Button
              variant={'outlined'}
              onClick={() => {
                console.log('change', dontShowWithdrawWarningState);
                setDontShowWithdrawWarning(true);
                localStorage.setItem('dontShowWithdrawWarning', 'true');
              }}
            >
              Withdraw Anyway
            </Button>
