      ...
      {isRevokeModal ? (
        ...
        >
          <Trans>
            ...
            your ZERO or stkZERO balance. Your tokens will remain in your account, but your delegate
            will be able to vote or propose on your behalf. If your stkZERO balance changes, your
