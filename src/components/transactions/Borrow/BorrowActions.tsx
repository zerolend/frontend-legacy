...
export const BorrowActions = React.memo(
  ({
    ...
    // const gaslessState = useGaslessPossible()
    ...
    const approval = async () => {
      try {
        if (requiresApproval && approvedAmount) {
          ...
          // if (currentMarketData.addresses.PAYMASTER && gaslessState.isGaslessPossible)
          //   response = await sendGaslessTx(approveDelegationTxData);
          // else
          //   response = await sendTx(approveDelegationTxData);
    ...
    const action = async () => {
      try {
        ...
        // let response: TransactionResponse;
        // if (currentMarketData.addresses.PAYMASTER)
        //   response = await sendGaslessTx(borrowTxData);
        // else
