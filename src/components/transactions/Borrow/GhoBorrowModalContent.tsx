...
export const GhoBorrowModalContent = ({
  ...
  return (
    <>
      ...
      <Typography sx={{ mb: 2 }}>
        You are going to mint ONEZ. Minted ONEZ needs to be repaid back with interest to release
        your locked collateral. To learn more about how ONEZ works, visit our{' '}
        <a href="https://docs.zerolend.xyz/onez" target="_blank" rel="noreferrer">
          documentation
        </a>
        .
      </Typography>
