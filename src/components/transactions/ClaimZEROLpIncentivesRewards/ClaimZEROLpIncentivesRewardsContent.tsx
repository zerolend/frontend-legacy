...
import { ClaimZEROLpIncentivesRewardsActions } from './ClaimZEROLpIncentivesRewardsActions';
...
export const ClaimZEROLpIncentivesRewardsContent = () => {
  ...
  return (
    <>
      ...
      <ClaimZEROLpIncentivesRewardsActions
