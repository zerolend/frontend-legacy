...
const WalletRow = ({ walletName, walletType }: WalletRowProps) => {
  ...
  return (
    ...
    >
      {walletName}
      {/* <Typography className={'preferred'}>{walletType === WalletType.OKX && 'Preferred'}</Typography> */}
    </Button>
  );
};
...
export const WalletSelector = () => {
  ...
  const handleBlocking = () => {
    switch (blockingError) {
      ...
      default:
        ...
        return <Trans>Error connecting. Try refreshing the page or unlocking your wallet</Trans>;
    }
  };
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column' }}>
      ...
      />
      <WalletRow key="okx_wallet" walletName="OKX Wallet" walletType={WalletType.OKX} />
      <WalletRow key="bitget_wallet" walletName="Bitget Wallet" walletType={WalletType.BITGET} />
      <WalletRow
