      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Trans>Zero Gravity: Zero to Zillion is LIVE</Trans>
            </Typography>
            <Typography
              sx={(theme) => ({
                [theme.breakpoints.up(1125)]: {
            ...
            >
              Zero Gravity is a points platform to distribute $ZERO incentives to the community.{' '}
              <br />
              Zero to Zillion is Zero Gravity’s first chapter allocating 5% of the $ZERO supply for
              early adopters seeding liquidity for the protocol.
            </Typography>
          </Box>
        </Box>
        <Button
        ...
        >
          <Trans>Enter Zero Gravity</Trans>
        </Button>
      </Box>
    </Box>
  );
