      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Trans>Join the ZERO Gravity Campaign 🎉</Trans>
            </Typography>
            <Typography
              sx={(theme) => ({
                [theme.breakpoints.up(1125)]: {
            ...
            >
              Borrow/Supply liquidity into the protocol and start farming points to get a share of
              the potential ZERO airdrop (alongside your earlyZERO rewards).
            </Typography>
          </Box>
        </Box>
        <Button
