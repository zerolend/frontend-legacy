...
import PointsIncentivesCard from '../../components/incentives/PointsIncentivesCard';
      ...
      >
        ...
        <PanelItem title={<Trans>APY</Trans>}>
          ...
          <PointsIncentivesCard
            showZeroIncentive={reserve.supplyAPY.toString() !== '-1'}
            symbol={reserve.symbol}
            isSupply={true}
            leftAlign={true}
          />
          ...
          <Box sx={{ pt: '42px', pb: '12px' }}>
            ...
            <Warning severity="warning">
              <Typography variant="subheader1">
                <Trans>This asset can only be used as collateral in isolation mode only.</Trans>
              </Typography>
              <Typography variant="caption">
                ...
                ceiling.{' '}
                <Link href="https://docs.zerolend.xyz/features/capital-efficiency/isolation-mode#how-can-i-enter-isolation-mode">
                  Learn more
                </Link>
              </Typography>
            </Warning>
