    ...
    if (!stkAave)
      alertText = (
        <Typography variant="caption" component="p" color="warning.dark">
          <Trans>Add stkZERO to see borrow APY with the discount</Trans>
        </Typography>
      );
  ...
  return (
    <>
      ...
      <Typography variant="caption" color="text.secondary" mb={6}>
        <Trans>
          Users who stake ZERO in Safety Module (i.e. stkZERO holders) receive a discount on GHO
          borrow interest rate. The discount applies to 100 GHO for every 1 stkZERO held. Use the
