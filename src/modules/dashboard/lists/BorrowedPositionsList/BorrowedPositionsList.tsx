...
import { marketBorrowBanners } from '../../../../ui-config/ui-banners-config';
...
export const BorrowedPositionsList = () => {
  ...
  console.log("hello", marketBorrowBanners[currentMarket], currentMarket);
  ...
  return (
    <ListWrapper
      ...
      topInfo={
        <>
          {marketBorrowBanners[currentMarket]}
    ...
    >
      {sortedReserves.length ? (
        <>
          {marketBorrowBanners[currentMarket] && marketBorrowBanners[currentMarket]}
