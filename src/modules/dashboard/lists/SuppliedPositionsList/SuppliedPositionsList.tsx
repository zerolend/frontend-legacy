      ...
      {sortedReserves.length > 0 ? (
        <>
          ...
          <Warning severity="info">
            ...
            <Trans>
              As a liquidity provider, you will get roles (Shrimp/Shark/Whale) in our discord that
        ...
        <>
          ...
          <Warning severity="info">
            ...
            <Trans>
              Users who provide liquidity will get special roles (Shrimp/Shark/Whale) in our discord
