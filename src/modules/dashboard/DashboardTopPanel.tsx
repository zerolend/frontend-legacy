...
export const DashboardTopPanel = () => {
  ...
  const { claimableRewardsUsd } = Object.entries(user.calculatedUserIncentives)
    .filter(([, data]) => currentMarketData.whiteListedIncentives.includes(data.rewardTokenSymbol.toLowerCase()))
    .reduce((acc, [rewardTokenAddress]) => {
  ...
  return (
    <>
      ...
      <TopInfoPanel
        ...
        pageDesc={
          <Trans>View all your positions, deposit/withdraw assets in this dashboard.</Trans>
        }
      >
