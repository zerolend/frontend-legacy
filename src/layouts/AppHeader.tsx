...
const BRIDGE_VISITED_KEY = 'bridgeVisited';
...
export function AppHeader() {
  ...
  const [visitedBridge, setVisitedBridge] = useState(() => {
    if (typeof window === 'undefined') return true;
    return Boolean(localStorage.getItem(BRIDGE_VISITED_KEY));
  });
  ...
  const handleBridgeClick = () => {
    localStorage.setItem(BRIDGE_VISITED_KEY, 'true');
    setVisitedBridge(true);
    openBridge();
  };
