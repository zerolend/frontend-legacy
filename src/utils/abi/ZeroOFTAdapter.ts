...
import {
  ...
  TypedEventFilter,
  TypedListener,
} from '@aave/contract-helpers/src/v3-migration-contract/typechain/common';
// import type {
//   TypedEventFilter,
//   TypedEvent,
//   TypedListener,
...
export interface ZeroOFTAdapterInterface extends utils.Interface {
  functions: {
...
export interface ZeroOFTAdapter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZeroOFTAdapterInterface;
